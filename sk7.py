...
heart_data = pd.read_csv(r'C:/Users/ajays/Desktop/New folder/heart.csv')
...
def heart1():
    ...
    ca = 0
    thal = 0
    #result1 = prediction[0] if prediction[0] == 0 else 1
...
# Using KNN model for prediction
    ...
    #return render_template('result1.html', prediction=result1)

   # result = prediction[0] if prediction[0] == 0 else 1
   # return render_template('heart1.html', result=result)

    return render_template('heart1.html', result1=result1)

    return render_template('heart1.html', result1=None)
'''
    # Debugging statement to check prediction result
...
# Debugging statement to catch any exceptions
print(f"Error during form processing: {e}")
return render_template('heart1.html', result="Error in form processing")

return render_template('heart1.html', result=None)
'''
